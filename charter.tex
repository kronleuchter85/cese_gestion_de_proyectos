...
\titulo{Sistema Embebido para un Robot de Exploración Ambiental} 
...
Por medio de la presente se acuerda con el Ing. \authorname\hspace{1px} que su Trabajo Final de la \degreename\hspace{1px} se titulará ``\ttitle'', consistirá esencialmente en \textcolor{black}{la implementación de un prototipo de un sistema embebido para un robot de exploracion ambiental}, y tendrá un presupuesto preliminar estimado de \textcolor{red}{600} h de trabajo y \textcolor{red}{\$14.000}, con fecha de inicio \fechaInicioName\hspace{1px} y fecha de presentación pública \fechaFinalName.
...
En una primera versión tendrá las funciones básicas de poder desplazarse, sensar el medio ambiente, ser controlado por un mando a distancia de manera cableada, y comunicar las diferentes mediciones al control de mandos para su visualización. No se cuenta con financiamiento de ninguna institución, y ni se destina a ningún cliente.
...
El propósito de este proyecto es volcar en un caso de la industria los conocimientos mas importantes aprendidos en la especialización de sistemas embebidos, tales como:
\begin{itemize}
	\item programación y diseño de sistemas embebidos, patrones de diseño y buenas prácticas.
	\item utilización de un sistema operativo para sistemas embebidos como FreeRTOS.
	\item integración y despliegue sobre una arquitectura ESP32.
	\item integración con hardware de medición, como por ejemplo los sensores que se dispondrán en el robot.
	\item integración con hardware de desplazamiento, como por ejemplo los motores.
\end{itemize}

Finalmente, cabe destacar, que si bien el robot de exploración ambiental del presente trabajo es una implementación abstracta con a funcionalidades genéricas (detalladas más adelante en la sección Alcance del Proyecto), su arquitectura podría ser extrapolada a casos de uso más interesantes y de valor en la industria como por ejemplo la exploración de suelos en el agro, la exploración submarina para la perforación de pozos de petróleo, o los antes mencionados en el estado del arte.
...
\begin{consigna}{black}
Las funcionalidades incluidas en el robot de exploración ambiental serán:
\begin{itemize}
	\item Sistema de desplazamiento: el robot debe ser capaz de desplazarse por medio de motores. Los movimientos contemplados sera hacia adelante, atras, y giros en ambas direcciones (360º).
	\item Operaciones de exploración: el robot contendrá sensores de humedad, temperatura, presencia de gas y nivel de luminosidad.
	\item Control: por medio de un Joystick cableado (en principio) se puede comandar sus movimientos.
	\item Visualización: por medio de un display se puede ver las lecturas de sus sensores.
\end{itemize}

Queda (inicialmente) fuera del alcance:
\begin{itemize}
	\item la función de visión desde el robot, para transmitir lo que visualiza desde una cámara, así como su renderización en el puesto de mandos.
	\item el uso de comunicación inalámbrica entre el robot y el puesto de mandos.
\end{itemize}


Desde el centro de mando conformado por el Joystick y el display se podrá:
\begin{itemize}
	\item controlar el desplazamiento, estado y operaciones del robot implementando un sistema de comunicación cableado.
	\item Mediante el joystick con un display se podrá renderizar el estado y lectura de los sensores.
\end{itemize}
