...
\begin{itemize}
	\item cualquier función de visión desde el robot,
...
\begin{enumerate}
	\item Requerimientos funcionales
		\begin{enumerate}
			\item El sistema debe contar con funciones de desplazamiento para poder moverse hacia adelante y atras, y poder girar radialmente hasta un angulo de 360 grados.
			\item El sistema debe ser capaz de eplorar
